...
# Generate random vehicle. National or International.
def vehicle(only_this_subclass=None):
    ...
    if only_this_subclass == vehicle.National:
        choice = 0
    elif only_this_subclass == vehicle.International:
        choice = 1
...
def vehicle_info():
    ...
    return [
        ...
        round(rd.random() / 4, 2),  # state taxes
